...
function EDITOR_setText(text, fileStartsWithBom, textSourceIdentifier, FORMATTED_textSourceIdentifier, extensionKind, lineEndString) {
    ...
    // TODO: I believe this works because when you change the text you guarantee a virtual index line of '0'...
        ...
        if (get_EDITOR_gutter().children[beltIndexLine_last].textContent === '~') {
            ...
            for (var i = 0; i < linesRemovedCount; i++) {
                if (successFoundTildeAtIndex > i) {
                    get_EDITOR_gutter().children[successFoundTildeAtIndex - (i + 1)].textContent = '~';
                }
            }
        }
